///////////////////////////////////////////////////////////////////////
// Executive.cs - Demonstrate Prototype Remote Code Analyzer          //
// ver 1.0                                                           //
// Language:    C#, 2017, .Net Framework 4.7.1                       //
// Platform:    Hp Spectre                                           //
// Application: Demonstration of Project 4 SMA, Fall 2018            //
// Author:      Jim Fawcett, CST 4-187, Syracuse University          //
//              (315) 443-3948, jfawcett@twcny.rr.com  
//Used by: Dhaval Sonavaria
///////////////////////////////////////////////////////////////////////
/*
 * Package Operations:
 * -------------------
 ...
 *     dependency analyzes and is called by the server to analyze client files
 */
/* Required Files:
 *   Executive.cs
 *   FileMgr.cs
...
namespace CodeAnalysis
{
  ...
  //   strong components
  // has methods used by the server to analyze files
   ...
   public class Executive
  {
    ...
    CsGraph<string,string> buildDependencyGraph()
    {
      ...
      return graph;
        ...
        public List<string> ServerCallForDependencyAnalysis(List<string> clientfiles)
        {
            FileStream ostrm;
            StreamWriter writer;
            ...
            ostrm = new FileStream("./Redirect" + i + ".txt", FileMode.OpenOrCreate, FileAccess.Write);
            ...
            exec.dependencyAnalysis(clientfiles);
            repo.dependencyTable.show();
            Console.SetOut(oldOut);
            writer.Close();
            ostrm.Close();
            string fileName = "Redirect" + i + ".txt";
        ...
        public List<string> ServerCallForStrongComponents (List<string> clientfiles)
    {
